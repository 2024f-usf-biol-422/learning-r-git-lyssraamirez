...
y. [@ggplotpkg] was used to execute a accurate visual box plot and scatter plot. 
The data in these graphs was subset from a large set of SNP samples, [@dplyrpkg] 
was used to manipulate the data from the original data frame. To accurately 
apply references and citations to support the figures [@citrpkg] was used to cite 
